...
**Due: 5pm Friday, March 18th** Submit URL of your final project (ie rendered Rmarkdown as HTML in `http://<org>.github.io` or Shiny app published to `http://<user>.shinyapps.io`) into GauchoSpace [final presentation](https://gauchospace.ucsb.edu/courses/mod/assign/view.php?id=541915) and [final paper](https://gauchospace.ucsb.edu/courses/mod/assign/view.php?id=541915).
